...
{:else if !isDesktopOrWider && isViewportInLandscapeOrientation === false}
	<div
	...
	>
		<p class="text-4xl font-barlow">
			<svg class="m-auto mb-8" width="70" height="70" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"
				><path
